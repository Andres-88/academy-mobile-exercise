...
public class LoginService {
    ...
    public static void isViewLoaded(){
        ...
        Assert.assertTrue(MobileActionManager.isVisible(LoginConstants.SIGN_IN_BUTTON_LOCATOR), LoginConstants.VIEW_NOT_DISPLAYED_MESSAGE);
    }
    ...
    public static void shotPhoto(){
        ...
        MobileActionManager.waitVisibility(LoginConstants.CAMERA_SHOT_BUTTON_LOCATOR);
        MobileActionManager.click(LoginConstants.CAMERA_SHOT_BUTTON_LOCATOR);
    }
}
